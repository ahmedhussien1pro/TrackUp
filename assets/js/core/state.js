window.state = {
  ...
  subTrackResult:      StorageAPI.get('trackup_subTrackResult',  null),
  ...
  chatMessages:        StorageAPI.get('trackup_chatMessages',    []),
  watchedSessions:     StorageAPI.get('trackup_watchedSessions', []),
  libraryFilter:       'all',
  auth:                null,
};
...
window.persistState = function persistState() {
  ...
  StorageAPI.set('trackup_subTrackResult',  state.subTrackResult);
  StorageAPI.set('trackup_chatMessages',    state.chatMessages);
  StorageAPI.set('trackup_watchedSessions', state.watchedSessions);
};
