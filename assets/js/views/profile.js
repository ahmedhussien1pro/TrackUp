        ...
        <div style="display:flex;align-items:flex-start;gap:1.25rem;flex-wrap:wrap;">
          ...
          <div style="flex:1;min-width:200px;">
            ...
            <div class="text-muted" style="font-size:.87rem;margin-top:.25rem;">
              ...
              ${p.year ? ` &mdash; ${[{value:'1',label:{en:'Year 1',ar:'سنة 1'}},{value:'2',label:{en:'Year 2',ar:'سنة 2'}},{value:'3',label:{en:'Year 3',ar:'سنة 3'}},{value:'4',label:{en:'Year 4',ar:'سنة 4'}},{value:'5',label:{en:'Year 5',ar:'سنة 5'}},{value:'graduate',label:{en:'Graduate',ar:'خريج'}},{value:'postgrad',label:{en:'Postgrad',ar:'دراسات عليا'}}].find(y=>y.value===p.year)?.label[lang]||''}` : ''}
            </div>
