window.renderSubTrackResultView = function renderSubTrackResultView() {
  ...
  const questions = (SUBTRACK_QUESTIONS && SUBTRACK_QUESTIONS[fieldKey]) || [];
  ...
  const platform = topKey && SUBTRACK_PLATFORMS ? SUBTRACK_PLATFORMS[topKey] : null;
    ...
    <div class="surface-panel section-pad" data-aos="fade-up">
      ...
      <div style="display:grid;gap:.7rem;">
        ${ranked.map(([key, pts], i) => {
          const pf = SUBTRACK_PLATFORMS && SUBTRACK_PLATFORMS[key];
          if (!pf) return '';
